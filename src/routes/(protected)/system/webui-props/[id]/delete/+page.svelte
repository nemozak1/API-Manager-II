    ...
    <div class="mx-auto max-w-2xl">
      ...
      >
          ...
          <div class="flex">
            ...
            <div class="ml-3">
              ...
              <p class="mt-2 text-sm text-red-700 dark:text-red-300">
                Deleting this property will permanently remove it from the
                system. Any features or pages that depend on this property may
        ...
        <form onsubmit={handleDelete}>
          <div
            class="mb-6 rounded-lg border border-yellow-300 bg-yellow-50 p-4 dark:border-yellow-800 dark:bg-yellow-900/20"
          >
